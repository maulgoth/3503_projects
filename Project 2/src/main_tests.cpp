...
int test()
{
	...
	for (int i = 0; i < 10; ++i) {
		...
		if (test == 10) {
			...
			if (writeFile("tests/test10.tga", Test10) == 1)
				if (CompareImages("tests/test10.tga", "examples/EXAMPLE_part10.tga") == 1) {
					count++;

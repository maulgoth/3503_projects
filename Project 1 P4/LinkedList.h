...
//
// Note: Additional citation for recursion principles are
// Provided at the PrintRecursive function definitions below
//
// **********************************************************
...
unsigned int LinkedList<T>::Remove(const T& data) {
	...
	// Loop over nodes and remove each, reducing count
	unsigned int i;
	for (i = 0; i < nodes.size(); ++i) {
		Node* x = nodes.at(i)->prev;
		Node* y = nodes.at(i)->next;
		x->next = y;
		y->prev = x;
		delete nodes.at(i);
		count--;
...
//************************************************************/
// Recursive code is original, but brushing up on recursion
// Came from:
//
// Title: Recursion
// Site: GeeksforGeeks
